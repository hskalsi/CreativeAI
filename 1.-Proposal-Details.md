...
- For the reach, we will implement Harmonic Sounds and use matplotlib to visualize the songs we've created. Instead of using songs from the Beatles, we intend to use songs from Taylor Swift, perhaps the greatest international artist of all time, maybe all history.
